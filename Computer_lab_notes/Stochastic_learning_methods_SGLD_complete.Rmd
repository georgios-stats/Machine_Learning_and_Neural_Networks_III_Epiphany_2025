---
title: "Stochastic Gradient Langevin Dynamic algorithm"
...
\,\,\,\,\,\,\,\,\,\,h_{w}\left(x\right)=\frac{\exp\left(x^{\top}w\right)}{1+\exp\left(x^{\top}w\right)}\\
w\sim\text{N}_{d}\left(\mu=0.0,V\right) & \text{( prior distribution)}
\end{cases}
\]
...
#
plot(w_chain[,2], type='l') +
abline(h=w_chain_clipping[2], col='red')
```
...
+ [LINK TO TASKS](http://htmlpreview.github.io/?https://github.com/georgios-stats/Machine_Learning_and_Neural_Networks_III_Epiphany_2025/blob/main/Computer_lab_notes/Stochastic_learning_methods_SGLD_NMM_tasks.html)  

+ [LINK TO SOLUTIONS](http://htmlpreview.github.io/?https://github.com/georgios-stats/Machine_Learning_and_Neural_Networks_III_Epiphany_2025/blob/main/Computer_lab_notes/Stochastic_learning_methods_SGLD_NMM_complete.html)  
